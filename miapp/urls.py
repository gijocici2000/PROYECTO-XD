...
urlpatterns = [
    ...
    path('cotizacion_detalle/eliminar/', views.eliminar_cotizacion_detalle, name='eliminar_cotizacion_detalle'),
    path('cotizacion_detalle/modificar/', views.modificar_cotizacion_detalle, name='modificar_cotizacion'),
